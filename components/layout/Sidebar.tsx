...
const Sidebar: React.FC<SidebarProps> = ({ activePage, setActivePage, isMobileOpen, onCloseMobile, isCollapsed, setIsCollapsed, onShowDomainQr }) => {
