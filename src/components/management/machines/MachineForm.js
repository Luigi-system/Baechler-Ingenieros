...
var MachineForm = function (_a) {
    var machine = _a.machine, onSave = _a.onSave, onCancel = _a.onCancel;
    var supabase = (0, SupabaseContext_1.useSupabase)().supabase;
    var _b = (0, react_1.useState)(machine || {
        serie: '',
        modelo: '',
        marca: '',
        linea: '',
    ...
    (0, react_1.useEffect)(function () {
        var fetchDataAndInitialize = function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, companiesRes, plantsRes, companiesData, allPlantsData, machineCompanyId, associatedPlant, defaultCompanyId_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), companiesRes = _a[0], plantsRes = _a[1];
                        companiesData = companiesRes.data || [];
                        allPlantsData = plantsRes.data || [];
                        setCompanies(companiesData);
                        setAllPlants(allPlantsData);
                        if (machine) {
                            machineCompanyId = machine.id_empresa;
                            ...
                            if (!machineCompanyId && machine.id_planta) {
                                associatedPlant = allPlantsData.find(function (p) { return p.id === machine.id_planta; });
                                if (associatedPlant) {
                                    machineCompanyId = associatedPlant.id_empresa;
                                }
                            }
                            // Set the form data with the (potentially derived) company ID.
                            setFormData(__assign(__assign({}, machine), { id_empresa: machineCompanyId }));
                        }
                        else {
                            defaultCompanyId_1 = companiesData.length > 0 ? companiesData[0].id : undefined;
                            setFormData(function (prev) { return (__assign(__assign({}, prev), { id_empresa: defaultCompanyId_1 })); });
                        }
                        setIsLoadingData(false);
                        return [2 /*return*/];
                }
    ...
    var handleChange = function (e) {
        ...
        if (name === 'id_empresa') {
            ...
            var isCheckbox_1 = type === 'checkbox';
            var checked_1 = e.target.checked;
            setFormData(function (prev) {
                var _a;
                return (__assign(__assign({}, prev), (_a = {}, _a[name] = isCheckbox_1 ? checked_1 : value, _a)));
            });
        }
    };
    var handleSubmit = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var payload, request, _a, data, error;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    e.preventDefault();
                    ...
                    setIsSaving(true);
                    payload = __assign(__assign({}, formData), { id_planta: Number(formData.id_planta), id_empresa: Number(formData.id_empresa) });
                    request = machine
